...
const Home: NextPage = () => {
  ...
  return (
    <Layout bgColor={""} headerBgLight={false} headerTextDark={false}>
      ...
      <div className={`bg-gradient-to-b ${color} to-[#212529]`}>
        <div className="carousel h-screen w-full">
          ...
          <button
            ...
            className="absolute bottom-20 left-10 flex items-center gap-2 rounded-full bg-base-100 px-6 py-3 font-bold"
          >
            explorar tienda
            <BsArrowRight />
          </button>
          ...
          <div className="collapse justify-center rounded-xl ">
            ...
            <div className="collapse-content bg-base-100 text-xs text-black">
              <p className=" pt-4 text-2xl">
                Kilo y media es una tienda sostenible, comprometida y cercana
                que ofrece productos orgánicos a granel, libres de plásticoy de
              ...
              <div className="w-full">
                ...
                <p className="p-8 text-base">
                  Si algo nos diferencia como tienda, es el compromiso que
                  tenemos con la salud de nuestros clientes. Cada día apostamos
                  por mejorar su bienestar y por ello, organizamos nuestros
                  productos de manera que no haya contaminación cruzada,
                  utilizando para cada producto un utensilio específico. Además,
                  al crear tu perfil puedes indicar tus alergias o intolerancias
                  y a nosotros nos aparecerá cuando compres un producto.
                </p>
              </div>
