...
function DropdownCheckAllergen(/*allergens: Record<Allergen, string>*/) {
  //   const options = Object.keys(allergens).map((key, i) => ({
  //     id: i,
  //     name: allergens[key] ?? "valor no encontrado",
  //     value: key,
  //   }));
