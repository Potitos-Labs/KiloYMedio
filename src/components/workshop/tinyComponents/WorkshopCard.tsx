function WorskhopCard({
  ...
  console.log(date);
  return (
    <div className=" mb-2 block h-[180px] max-h-[230px] w-full cursor-pointer rounded-md border-[1px] border-base-content px-8 py-3 active:bg-base-content active:text-background">
      {date && (
